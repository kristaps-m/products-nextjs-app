...
const ProductDetails = () => {
  ...
  //     agent.Catalog.details(Number(productId))
  //       .then((data) => {
  //         // Check if data has a 'products' property and extract the first product
  ...
  console.log(product, "this is the one product");
  //console.log(product.products, "this is product.products");
